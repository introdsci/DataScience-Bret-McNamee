...
In order to make sure that the gold is being put into use in the most effective way possible would be to look up your team before the game and see how impactful each player is, and you could use that to see where the gold is best spent.

As for seeing what the better option is for staying alive as opposed to sacrificing yourself for a teammate, that would be more of a snap judgement in the game at the time. You would need to make sure to have a grasp of where the game is currently at, as well as what impact the death will have, along with whether or not there is a potential option for no deaths at all.
